                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Authors Name">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pictures" class="form-control @error('pictures') is-invalid @enderror" placeholder="Authors Pictures">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Authors Address">
