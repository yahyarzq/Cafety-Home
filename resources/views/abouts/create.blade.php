                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="artikel1" class="form-control @error('address') is-invalid @enderror" placeholder="Foto 1">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="artikel2" class="form-control @error('address') is-invalid @enderror" placeholder="Foto 2">
                                    <small class="text-danger">@error('foto1') {{$message}} @enderror</small>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="artikel3" class="form-control @error('address') is-invalid @enderror" placeholder="Titie 2">
                                    <small class="text-danger">@error('foto1') {{$message}} @enderror</small>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title2" class="form-control @error('name') is-invalid @enderror" placeholder="Title 1">
                                    <small class="text-danger">@error('title1') {{$message}} @enderror</small>
                                </div>
                            </div>
                            <div class="col-6">
