            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('faqs.index') }}">Authors</a></li>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="question" class="form-control @error('name') is-invalid @enderror" placeholder="Pertanyaan" value="{{$faqs->question}}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="answer" class="form-control @error('pictures') is-invalid @enderror" placeholder="Jawaban" value="{{$faqs->answer}}">
