            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title">Data table of Contacts</h3>
                        <a href="{{ route('contacts.create') }}" class="btn btn-sm btn-success"><i
                                class="fas fa-plus"></i>
                            Create</a>
                    </div>
                </div>
                            ...
                            @foreach ($contacts as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="float-left m-1" action="{{ route('contacts.destroy', [$item->id]) }}" method="POST">
                                            @method('delete')
                                            @csrf
