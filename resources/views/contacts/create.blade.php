                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat" class="form-control @error('name') is-invalid @enderror" placeholder="Alamat">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control @error('address') is-invalid @enderror" placeholder="Email">
